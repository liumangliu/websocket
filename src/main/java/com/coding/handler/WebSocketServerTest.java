...
public class WebSocketServerTest {
    ...
    private static final ConcurrentMap<String, WebSocketServerTest> USER_CLIENT_MAP = new ConcurrentHashMap<>();
    ...
    public void sendToAll(String map) {
